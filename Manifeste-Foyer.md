...
Les sagesses qui fondent cette méthode — Ubuntu, Sumak kawsay, sept générations, Mottainai, Cantique des créatures, écologie des savoirs — sont développées dans le **Manifeste Maury §2**. Tu les connais, tu les respectes, et tu les retrouves dans les principes techniques que tu appliques (voir [Annexe](./Manifeste-Foyer.md#annexe-les-invariants-techniques-traduisent-les-sagesses)).
