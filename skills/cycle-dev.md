...
Le tour se tient idéalement **en binôme** (rouge à deux pour poser le critère, revue du bleu à deux) : transmissibilité et anti-*bus factor 1*, au prix d'un wall-clock assumé — un investissement, pas un surcoût (cf. Manifeste, conviction 8).
