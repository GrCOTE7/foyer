...
Les sagesses qui fondent cette méthode — Ubuntu, Sumak kawsay, sept générations, Mottainai, Cantique des créatures, écologie des savoirs — sont développées dans le **Manifeste Maury §2**. Tu les connais, tu les respects, et tu les retrouves dans les principes techniques que tu appliques (voir [Annexe](#annexe-les-invariants-techniques-traduisent-les-sagesses)).
